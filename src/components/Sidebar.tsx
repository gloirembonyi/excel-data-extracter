...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const workingApiKeys = apiKeyStatuses.filter(
    (key) => key.status === "working"
  ).length;
  ...
  const handleDatasetUpload = async () => {
    if (!onDatasetUpload || uploadFiles.length === 0 || !datasetName.trim())
      return;
        ...
        <Stack gap={0} style={{ height: "100%" }}>
          ...
          <Stack gap="xs" p="xs" style={{ flex: 1 }}>
            <Button
              ...
              style={{
                backgroundColor:
                  activeTab === "extract" ? "#176B87" : "transparent",
            ...
            <Button
              ...
              style={{
                backgroundColor:
                  activeTab === "compare" ? "#176B87" : "transparent",
            ...
            <Button
              ...
              style={{
                backgroundColor:
                  activeTab === "projects" ? "#176B87" : "transparent",
            ...
            <Button
              ...
              style={{
                backgroundColor:
                  activeTab === "tools" ? "#176B87" : "transparent",
            ...
            <Button
              ...
              style={{
                backgroundColor:
                  activeTab === "search" ? "#176B87" : "transparent",
      ...
      >
        ...
        <Group justify="flex-end" mt="xl">
          ...
          <Button
            ...
            disabled={
              !datasetName.trim() || uploadFiles.length === 0 || isUploading
            }
            radius="lg"
            style={{
              backgroundColor: "#176B87",
